...
import editQuestionApi from '../../apis/edit-question.api';
import deleteQuestionApi from '../../apis/edit-question.api';
            ...
            <div className='start-analyze-button-container' style={{ minHeight: '10vh' }}>
                ...
                <Button
                    ...
                    onClick={() => {
                        ...
                        editQuestionApi(index, setChanged, question.title, option, question.category_id)

                    }}> ثبت تغییرات
                </Button>

                <DialogButton deleteFunc={() => {
                    deleteQuestionApi(index, setDeleted, question.category_id)
                    setDeleted((oldState) => {
